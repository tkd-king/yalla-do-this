...
const HousePaintingSection = () => {
  return (
    <Container>
      <div className="w-[60%] flex flex-col items-center justify-center gap-[20px] my-[50px] ml-[200px] text-center">
      <h2 className="text-blue-900 text-[30px] font-[700] text-center">
        Our Services House Painting Services
      </h2>
      <p className="text-[#61657e] text-[18px] font-[400]  ">
      ...
      <div className="grid grid-cols-3 gap-[10px] items-center justify-center">
        {items.map((item) => (
          <div
            key={item.id}
