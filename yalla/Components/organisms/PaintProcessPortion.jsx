...
const PaintProcessPortion = () => {
  ...
  return (
    <div>
      <div className="w-[50%] flex flex-col items-center justify-center gap-[20px] my-[100px] ml-[300px] text-center">
      ...
      <div className="grid grid-cols-2 gap-[20px] my-[50px]">
        {Process.map((item) => (
          <div key={item.id} className="bg-[#F4F6FF] rounded-[20px] p-[10px] ">
